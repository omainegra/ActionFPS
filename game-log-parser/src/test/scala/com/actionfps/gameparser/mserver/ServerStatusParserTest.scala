...
/**
  ...
  */
class ServerStatusParserTest extends FunSuite with Matchers {

  test("server Status parser works") {
    val message =
      """Status at 22-05-2015 15:14:59: 4 remote clients, 4.1 send, 2.1 rec (K/sec); Ping: #23|1022|34; CSL: #24|1934|72 (bytes)"""
  ...
  test("Extract message for tabular works") {
    val fullMessage =
      "2015-05-22T13:17:24.097Z\t62-210-131-155.rev.poneytelecom.eu aura AssaultCube[local#1999]\tStatus at 22-05-2015 15:14:59: 45 remote clients, 4.1 send, 2.1 rec (K/sec); Ping: #23|1022|34; CSL: #24|1934|72 (bytes)"
  ...
  test("Shift is good") {
    val fullMessage =
      """Date: 2015-05-22T13:17:24.097Z, Server: 62-210-131-155.rev.poneytelecom.eu aura AssaultCube[local#1999], Payload: Status at 22-05-2015 15:14:59: 45 remote clients, 4.1 send, 2.1 rec (K/sec); Ping: #23|1022|34; CSL: #24|1934|72 (bytes)"""
  ...
  test("Bad stuff doesn't cause failure") {
    val serverMessage =
      """Status at 22-05-2015 15:14:Xx59: 45 remote clients, 4.1 send, 2.1 rec (K/sec); Ping: #23|1022|34; CSL: #24|1934|72 (bytes)"""
    ServerStatus.unapply(serverMessage) shouldBe empty
  }

  test("Bad stuff doesn't cause failure (int)") {
    val serverMessage =
      """Status at 22-05-2015 15:14:59: 4x45 remote clients, 4.1 send, 2.1 rec (K/sec); Ping: #23|1022|34; CSL: #24|1934|72 (bytes)"""
    ServerStatus.unapply(serverMessage) shouldBe empty
  }
  ...
  test("Opposite shift is good") {
    val fullMessage =
      """Date: 2015-05-07T17:37:44.435Z, Server: 104.219.54.14 tyrwoopac AssaultCube[local#1999], Payload: Status at 07-05-2015 13:35:20: 9 remote clients, 16.2 send, 4.8 rec (K/sec); Ping: #49|2545|86; CSL: #24|4740|72 (bytes)"""
  ...
  test("LA shift is good") {
    val fullMessage =
      """Date: 2015-12-24T00:41:16.092Z, Server: 104.255.33.235 la AssaultCube[local#33333], Payload: Status at 23-12-2015 19:39:03: 1 remote clients, 25.3 send, 0.4 rec (K/sec); Ping: #486|28889|2124; CSL: #12|474|126 (bytes)"""
    val ExtractMessage(d, _, ServerStatus(serverStatusTime, _)) = fullMessage
