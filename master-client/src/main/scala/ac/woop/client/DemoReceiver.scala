...
class DemoReceiver(service: ActorRef, remote: PeerId) extends Act with ActorLogging {
  whenStarting {
    service ! SendMessageAddition(remote, 0)(22, ByteString.empty)
  }
  whenStopping {
    service ! SendMessageAddition(remote, 0)(23, ByteString.empty)
  }
  become {
