...
?>
    <div id="questions">
        ...
        <form class="pure-form pure-form-aligned" id="reg_form" method="post" enctype="multipart/form-data" action="https://script.google.com/macros/s/AKfycbw2na0_P4atptBWe_AXn2TJECge8POwV-3ai5QGJ2hd25TffWtY/exec">
            <fieldset>

                <div class="pure-control-group">
                    <label for="nickname">Nickname</label>
                    <input name="nickname" id="field-nickname" type="text" placeholder="In-game nickname, e.g. w00p|Drakas" pattern="[^\s]+{3,15}">
                    <p>Anything valid, 3 characters minimum.</p>
                </div>

                <div class="pure-control-group">
                    <label for="name">Username</label>
                    <input name="name" id="field-username" type="text" placeholder="Simple name, without clan tag, e.g. Drakas" pattern="[A-Z]?[a-z]{3,15}">
                    <p>First letter can be uppercase, the rest must be lowercase</p>
                </div>

                <div class="pure-control-group">
                    <label for="id">User ID</label>
                    <input type="text" id="field-id" name="id" placeholder="3 or more a-z characters, e.g. drakas" pattern="[a-z]{3,10}"/>
                    <p>Lowercase letters only.</p>
                    <p>Your profile will be available at <code>https://actionfps.com/player/?id=<span id="player-id-value"></span></code></p>
                </div>
        ...
        <p><a href="http://woop.ac/client/windows_client_1202.2.exe" class="button-error pure-button">Download ActionFPS Match Client</a></p>
        ...
        <p><a href="ts3server://aura.woop.ac:9988"><img src="https://cloud.githubusercontent.com/assets/2464813/12760873/99820c6e-c9e0-11e5-832d-00c1b61c2e4c.png"/></a></p>
